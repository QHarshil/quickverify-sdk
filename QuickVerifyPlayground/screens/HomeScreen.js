...
export function HomeScreen({ onStart, biometricAvailable, onCheckBiometric, onTestBiometric }) {
  return (
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        <TouchableOpacity
          ...
          onPress={onCheckBiometric}
        >
          <Text style={styles.secondaryButtonText}>Check Biometric</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.secondaryButtonText}>Test Biometric</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
